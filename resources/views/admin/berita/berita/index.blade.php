...
<div  class="card mt-4">
  <div class="card-body">
      <div class="d-sm-flex d-block align-items-center justify-content-between mb-4">
          <h4 class="card-title"><strong>Berita</strong></h4>
          <a href="{{route("berita.berita.create")}}">
            ...
            <tbody>
              ...
              <tr>
                <td class="border-bottom-0">
                  <p class="mb-0 fw-semibold">{{$item->judul}}</p>
                  {{-- <p class="mb-0 fw-semibold">{{$item->nm_jenis}}</p> --}}
                </td>
                <td class="border-bottom-0 text-center">
                  <a href="{{ route('berita.berita.edit',$item->id ) }}">
                    <button type="button" class="btn btn-icon btn-warning">
                      <span class="tf-icons bx  bx-pencil"></span>
                    </button>
                  </a>
                  <button type="button" onclick="deletekategori('{{ route('berita.berita.destroy',$item->id) }}')"  class="btn btn-icon btn-danger">
