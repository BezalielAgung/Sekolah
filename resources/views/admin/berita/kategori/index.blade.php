...
<div  class="card mt-4">
  <div class="card-body">
      <div class="d-sm-flex d-block align-items-center justify-content-between mb-4">
          <h4 class="card-title"><strong>Jenis</strong></h4>
          <a href="{{route("berita.kategori.create")}}">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border-bottom-0 text-center">
                  <a href="{{ route('berita.kategori.edit', $item->id ) }}">
                    <button type="button" class="btn btn-icon btn-warning">
                      <span class="tf-icons bx  bx-pencil"></span>
                    </button>
                  </a>
                  <button type="button" onclick="deletekategori('{{ route('berita.kategori.destroy',$item->id) }}')"  class="btn btn-icon btn-danger">
