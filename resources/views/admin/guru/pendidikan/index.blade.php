...
<div  class="card mt-4">
  <div class="card-body">
      <div class="d-sm-flex d-block align-items-center justify-content-between mb-4">
          <h4 class="card-title"><strong>Pendidikan</strong></h4>
          <a href="{{route("guru.pendidikan.create")}}">
            ...
            <thead class="text-dark fs-4 table-primary">
              <tr>
                <th class="border-bottom-0">
                  <h6 class="fw-semibold mb-0">Nama Pendidikan</h6>
                </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border-bottom-0 text-center">
                  <a href="{{ route('guru.pendidikan.edit', $item->id ) }}">
                    <button type="button" class="btn btn-icon btn-warning">
                      <span class="tf-icons bx  bx-pencil"></span>
                    </button>
                  </a>
                  <button type="button" onclick="deletekategori('{{ route('guru.pendidikan.destroy',$item->id) }}')"  class="btn btn-icon btn-danger">
